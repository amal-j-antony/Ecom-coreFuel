...
const defaultTips = [
  {
    text: "Best Protein bars on the block",
      ...
      <div className="w-full overflow-hidden rounded-xl">
        <Carousel
                      ...
                      <motion.div
                        ...
                        {displayTips[current]?.url ? (
                          <a
                            ...
                            <p
                              className="wrap-break-word text-center text-base font-medium leading-relaxed tracking-tight text-white text-pretty sm:text-lg md:text-left md:text-xl lg:text-2xl lg:font-bold">
                              {tip.text}
                            </p>
                          </a>
                        ) : (
          ...
          {showNavigation && (
            <>
              <CarouselPrevious
                className="absolute left-2 top-1/2 h-10 w-10 -translate-y-1/2 transition-transform active:scale-[0.96]" />
              <CarouselNext
                className="absolute right-2 top-1/2 h-10 w-10 -translate-y-1/2 transition-transform active:scale-[0.96]" />
            </>
          )}
        </Carousel>
        <div
              ...
              {backgroundTips ? (
                ...
                <div className="min-w-0 max-w-full">
                  {displayTips[current]?.url ? (
                    ...
                    <span
                      className="wrap-break-word block max-w-full text-base font-medium leading-tight tracking-tight text-pretty lg:text-2xl xl:font-semibold">
                      {displayTips[current]?.text}
                    </span>
                  )}
                </div>
